 ...
 *
 * Uses the same scrypt params as the AdonisJS hash config (cost 16384, block 8, parallel 1).
 * Zero external dependencies — works in standalone scripts and in the AdonisJS context.
 */
